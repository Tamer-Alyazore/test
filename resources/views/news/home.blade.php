...
<header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item" style="background-image: url('{{ asset('news/img/22.jpg') }}')">
                <div class="carousel-caption d-none d-md-block">
...
<section class="gray-sec">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top" src="{{ asset('news/img/3.jpeg') }}" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top" src="{{ asset('news/img/2.jpg') }}" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
        ...
        <div align="center"><a class="btn btn-success" href="all-news.html">more news</a></div>
    </div>
</section>
<section >
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3  portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top" src="{{ asset('news/img/s4.jpg') }}" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
            ...
            <div class="col-lg-3  portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top" src="{{ asset('news/img/s1.jpg') }}" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="#">news title Four</a>
                        </h4>
            ...
            <div class="col-lg-3  portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top" src="{{ asset('news/img/s2.jpg') }}" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
            ...
            <div class="col-lg-3  portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top" src="{{ asset('news/img/s3.jpg') }}" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
