...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
          <div class="col-md-7">
            <a href="newsdetailes.html">
              <img class="img-fluid full-width h-200 rounded mb-3 mb-md-0" src="{{ asset('news/img/22.jpg') }}" alt="">
            </a>
          </div>
          <div class="col-md-5">
        ...
        <div class="row">
          <div class="col-md-7">
            <a href="newsdetailes.html">
              <img class="img-fluid full-width h-200 rounded mb-3 mb-md-0" src="{{ asset('news/img/s1.jpg') }}" alt="">
            </a>
          </div>
          <div class="col-md-5">
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <a href="newsdetailes.html">
              <img class="img-fluid full-width h-200 rounded mb-3 mb-md-0" src="{{ asset('news/img/5.jpeg') }}" alt="">
            </a>
          </div>
          <div class="col-md-5">
