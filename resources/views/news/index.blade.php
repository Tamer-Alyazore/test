...
<section class="gray-sec">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top" src="img/3.jpeg" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
...
<section >
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3  portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top" src="img/s1.jpg" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
                            <a href="#">news title Four</a>
                        </h4>
            ...
            <div class="col-lg-3  portfolio-item">
                <div class="card h-100">
                    <a href="#"><img class="card-img-top" src="img/s3.jpg" alt=""></a>
                    <div class="card-body">
                        <h4 class="card-title">
